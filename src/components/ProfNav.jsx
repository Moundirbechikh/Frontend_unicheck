...
import { LayoutGrid, Users, FileText, PlayCircle } from 'lucide-react';
...
const ProfNav = () => {
  ...
  // Ajout de l'item "Cours" pour le lancement des séances
  const navItems = [
          ...
          <div className="flex justify-between items-center h-20">
            ...
            >
              ...
              <span className="font-display font-extrabold text-2xl tracking-tighter text-[#1a1c1e]">
                Unicheck <span className="text-[#006c49] text-sm ml-1">Prof</span>
              </span>
            </div>
