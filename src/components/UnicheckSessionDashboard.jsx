...
export default function UnicheckSessionDashboard({ seance }) {
  ...
  useEffect(() => {
    ...
    fetchPresences();
    const interval = setInterval(fetchPresences, 3000);
...
function MobileTopBar({ onOpenSearch, onOpenScanner }) {
  return (
    <div className="flex gap-3 items-stretch">
      <div className="bg-white rounded-[1.5rem] px-4 py-3 border border-gray-100 shadow-sm
        ...
        <div>
          <p className="font-black text-[#1a1c1e] text-[10px] uppercase tracking-widest leading-tight">
            Session Active
          </p>
      ...
      <button onClick={onOpenSearch}
        className="bg-white rounded-[1.5rem] border border-gray-100 shadow-sm
                   flex flex-col items-center justify-center gap-1.5 px-4 py-3
